...
alter table equipment_weapon drop foreign key sensor_range_id_refs_id_9f82dcb0;
alter table equipment_weapon change column `sensor_range_id` `sensor_range` integer NOT NULL;
