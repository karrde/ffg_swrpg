...
urlpatterns = patterns('',
    ...
    url(r'^weaponqualities/$', WeaponQualityListView.as_view(), name='weaponqualities'),
    url(r'^weaponqualities/(?P<pk>\d+)/$', WeaponQualityDetailView.as_view(), name='weaponquality'),
